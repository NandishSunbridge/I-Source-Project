page 75113 "PR RFQ SubForm"
{
    //AutoSplitKey = true; //AA25052023 Discussion
    Caption = 'PR RFQ SubForm';
    //DelayedInsert = true; //AA25052023 Discussion
    PageType = ListPart;
    SourceTable = "PR RFQ Line";
    ...
    begin
        PRRFQHeader.Get(Rec."Document Type", Rec."Document No.");
        if PRRFQHeader.Status = PRRFQHeader.Status::Released then
            FieldsDisable();
